...
namespace RetroDRY
{
    ...
    internal class LockManager
    {
        ...
        /// </summary>
        private readonly int ServerLifeNumber;
        ...
        private readonly Func<DbConnection> GetLockConnection;

        private readonly Func<DatonKey, string, Task> ChangePropogator;
        ...
        public LockManager(Func<DbConnection> lockDatabaseConnection, Func<DatonKey, string, Task> changePropogator)
        {
