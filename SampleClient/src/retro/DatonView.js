...
//todo delete
//create panel with single button to go to the next page; currentPageNo may be NaN or falsy if we are on page 0
// function buildBottomPagingButtons(layer, currentPageNo) {
//     if (isNaN(currentPageNo) || !currentPageNo) currentPageNo = 0;
//     return <div className="page-select-panel"><button onClick={() => layer.stackstate.goToPage(layer, currentPageNo + 1)}>Show Next Page</button></div>;
//     //todo language
// }
...
export default React.memo(props => {
    ...
    if (topStyle === 'c') {
        ...
        if (datonDef.multipleMainRows) {
            ...
            // let bottomPagingButtons = null; todo
            // if (layer && !daton.isComplete) bottomPagingButtons = buildBottomPagingButtons(layer, parseInt(criset.current._page));
            topContent = <>
                {topPagingButtons}
