...
-   To register, call Session.registerCardLayout or registerGridLayout with arguments (datonName, tableName, layout).
...
-   functions in the prototype of Session
    ...
    -   registerCardLayout(datonName, tableName, layout) - registers the default layout for all daton stacks for the daton/table
    -   registerGridLayout(datonName, tableName, layout) - registers the default layout for all daton stacks for the daton/table
    -   getCardLayout(datonName, tableName) - get the registered or autogenerated card layout
    -   getGridLayout(datonName, tableName) - get the registered or autogenerated grid layout
